...
final class Config
{
  ...
  public static int layoutId_of_string(String name)
  {
    switch (name)
    {
      ...
      case "qwerty3_nbr_row": return R.xml.qwerty3_nbr_row;
      case "qwerty3_nbr_row_shift": return R.xml.qwerty3_nbr_row_shift;
  ...
  public static int layoutNumId_of_string(String name)
  {
    switch (name)
    {
      ...
      case "qwerty3_nbr_row": return R.xml.numeric2;
      case "qwerty3_nbr_row_shift": return R.xml.numeric2_shift;
